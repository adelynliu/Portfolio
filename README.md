...
- [Education](#Education)
- [Projects](#Projects)
  + [Online_Retail_and_Inventory_Management_System](#Online_Retail_and_Inventory_Management_System)
...
- ### Online_Retail_and_Inventory_Management_System
  ...
  - **Description:** Developed an Online Retail and Inventory Management System using MySQL.
    Created an Entity-Relationship Diagram (ERD), designed the database schema, and inserted sample data. Formulated SQL queries to answer business questions, such as retrieving total product quantities in each warehouse or calculating sales revenue for specific sellers. The project provides a comprehensive solution for managing customers, sellers, products, orders, returns, and more, facilitating data-driven insights for effective business decisions.
  - **ERD:**
